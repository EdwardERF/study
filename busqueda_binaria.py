...
# Cuando respuesta está dentro de conjunto ORDENADO, se puede usar este algoritmo
# SUPER eficiente, acorta pasos respecto a enumeración exhaustiva
# Importante para computer science

# Pasos de este algoritmo:
# 1 - Cortar conjunto a la mitad (ejemplo, conjunto de valores del 1 al 10, se dividen en el punto 5)
# 2 - Condicional (if): valor buscado es mayor o menor que 5? De acuerdo a respuesta, tomar mitad del conjunto mayor o menor a 5.
# 3 - Iterar paso 2 cuantas veces sea necesario (loop)
# 4 - Valor es encontrado (se puede agregar un margen de error para encontrar el valor buscado)
